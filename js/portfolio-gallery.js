...
$(document).ready(function () {
	//Run jQuery after document loads
	...
	function projectCards(projects) {
		$.each(projects, function (index, currentProject) {
			// Select the projects input --> Iterate through each project

			let html = "<div class=\"container card-body\">";
			html += "<div class=\"card-title\">" + currentProject.title + "</div>";
			html +=
                "<p class=\"card-date\"><em>" + currentProject.date + "</em></p>";
			html +=
                "<div class=\"card-img\"><div class=\"overlay-effect\"></div>" +
                currentProject.img +
                "</div>";
	...
	const projects = [
		// An array of projects
		{
			...
			img:
                "<img src=\"img/giorgio-trovato-v_bri4iVuiM-unsplash.jpg\" class=\"image\"  alt=\"\">",
			date: "February 2020",
